...
import { api, type WhatsappLaunchConfig } from "../services/api";
import WhatsAppPopup from "./WhatsAppPopup";

export default function WhatsAppWidget() {
  const [config, setConfig] = useState<WhatsappLaunchConfig | null>(null);
  ...
  return (
    <>
      <div className="wa-widget" aria-label={label}>
        {hovered && (
          <span className="wa-tooltip">{label}</span>
        )}
        <button
          className="wa-fab"
          type="button"
